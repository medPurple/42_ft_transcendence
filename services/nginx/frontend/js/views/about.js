export default () => `
	...
	<div class="glass-card" style="max-width:760px; text-align:left;">
		<p style="margin:0 0 1rem; display:block;">This project marks the culmination of the 42 School main curriculum.</p>

		<p style="margin:0 0 1rem; display:block;">Our goal was to create an engaging online platform for the Classic Pong game, 
		...
		<p style="margin:0 0 1rem; display:block;">We incorporated a variety of additional features, using Django and DjangoRest for backend and API 
		...
		<p style="margin:0 0 1rem; display:block;">Emphasizing gameplay and user experience, we implemented remote player functionality, alternative game 
		...
		<p style="margin:0 0 1rem; display:block;">In the DevOps domain, our focus was on microservices architecture for scalability. We prioritized a visually 
			appealing and user-friendly interface, using Three.js and WebGL for 3D graphics and rendering in the main game.</p>

		<p style="margin:0 0 1rem; display:block;">Furthermore, we developed a server-side Pong game, utilizing an API for seamless integration and websockets 
			to enhance the experience for users with high-latency connections.</p>

		<p style="margin:0 0 1rem; display:block;">To further enhance the user experience, we introduced a second game: the Metaverse, a 2D Pokémon-like game
