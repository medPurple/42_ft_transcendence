...
VAULT_TOKEN=$(cat /run/secrets/vault_token_game3d)
...
uvicorn game3d.asgi:application --workers 1 --host 0.0.0.0 --port 4430 --ssl-keyfile=/tmp/server.key --ssl-certfile=/tmp/server.crt
